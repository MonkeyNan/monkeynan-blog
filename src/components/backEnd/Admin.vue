<template lang="html">
  <el-row class="panel">
    <el-row class="top">
      <el-col :span="23" class="panel-top" :push="1"> <!-- push就是相对定位，offset设置的事margin-left -->
        <el-col :span="20" style="font-size: 26px;">
          <span>AD<i style="color: #20a0ff;">MIN</i></span>
        </el-col>
        <el-col :span="4" class="rightbar">
          <el-dropdown trigger="click">
            <span class="el-dropdown-link" style="color:#c0ccda;cursor: pointer;font-weight:700;">更多操作<i class="el-icon-caret-bottom el-icon-right"></i></span>
