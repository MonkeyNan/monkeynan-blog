    ...
    <el-col :span="24">
      <el-form ref="articleCreate" :model="article" :rules="createRules">
        <el-row style="margin-top:20px;">
          <el-col :span="10" :push="1">
            <el-form-item label="文章标题" label-width="90px;" prop="title">
              <el-input v-model="articleTitle" style="width:260px;" placeholder="请在此处输入标题">
              </el-input>
            </el-form-item>
          </el-col>
        ...
        <el-form-item style="padding:20px 20px 0 0;">
          <el-button type="primary" style="float: right;" size="samll" @click="createArticle" :loading="load">{{ btnText }}</el-button>
          ...
          if (valid) {
            this.$confirm("确认提交吗？","提示", {})
              .then(() => {
                ...
                api.createArticle({
                  contentToMark: this.markedToHtml, ...this.article
                })
