        ...
        <el-row style="margin-top: 20px;">
          <el-col :span='10' :push="1">
            <el-form-item label="文章标题" label-width="90px" prop="title">
              <el-input v-model="article.title" style="width:260px" placeholder="请在此输入标题"></el-input>
            </el-form-item>
          </el-col>
...
import 'highlight.js/style/atom-one-dark.css'
  ...
  data() {
    return {
      ...
      createRules: {
        ...
        content: [
          { reuqired: true, message: '请输入内容', trigger: 'blur' }
        ],
        classify: [
